  ...
  const serviceDetails = [
    {
      ...
      features: ['Análisis de mercado', 'Planificación estratégica', 'Implementación tecnológica'],
    },
    {
      id: 2,
      ...
      features: ['Aplicaciones web', 'Aplicaciones móviles', 'Integraciones API'],
    },
    {
      id: 3,
      ...
      features: ['SEO & SEM', 'Gestión de redes sociales', 'Estrategias de contenido'],
    },
  ];
